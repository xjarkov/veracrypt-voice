...
MainFrameBase::MainFrameBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	wxMenuItem* VoiceDismountMenuItem;
	VoiceDismountMenuItem = new wxMenuItem( ToolsMenu, wxID_ANY, wxString( _("Voice Dismount") ) , wxEmptyString, wxITEM_NORMAL );
	ToolsMenu->Append( VoiceDismountMenuItem );
	...
	VolumeButton = new wxButton( sbSizer4->GetStaticBox(), wxID_ANY, _("&Mount"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	MountAllDevicesButton = new wxButton( sbSizer41->GetStaticBox(), wxID_ANY, _("&Auto-Mount Devices"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	DismountAllButton = new wxButton( sbSizer42->GetStaticBox(), wxID_ANY, _("Di&smount All"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	ExitButton = new wxButton( sbSizer43->GetStaticBox(), wxID_ANY, _("E&xit"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	ToolsMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnVoiceDismountMenuItemSelected ), this, VoiceDismountMenuItem->GetId());
...
EncryptionTestDialogBase::EncryptionTestDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText43 = new wxStaticText( sbSizer38->GetStaticBox(), wxID_ANY, _("Key size:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText45 = new wxStaticText( sbSizer39->GetStaticBox(), wxID_ANY, _("Secondary key (hexadecimal)"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText46 = new wxStaticText( sbSizer39->GetStaticBox(), wxID_ANY, _("Data unit number (64-bit, data unit size is 512 bytes)"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText47 = new wxStaticText( sbSizer39->GetStaticBox(), wxID_ANY, _("Block number:"), wxDefaultPosition, wxDefaultSize, 0 );
...
KeyfileGeneratorDialogBase::KeyfileGeneratorDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText52 = new wxStaticText( sbSizer43->GetStaticBox(), wxID_ANY, _("Random Pool:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	ShowRandomPoolCheckBox = new wxCheckBox( sbSizer43->GetStaticBox(), wxID_ANY, _("Show"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer45 = new wxStaticBoxSizer( new wxStaticBox( sbSizer43->GetStaticBox(), wxID_ANY, _("Randomness Collected From Mouse Movements") ), wxVERTICAL );
	...
	MouseStaticText = new wxStaticText( sbSizer43->GetStaticBox(), wxID_ANY, _("IMPORTANT: Move your mouse as randomly as possible within this window. The longer you move it, the better. This significantly increases the cryptographic strength of the keyfile."), wxDefaultPosition, wxDefaultSize, 0 );
...
MountOptionsDialogBase::MountOptionsDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	ReadOnlyCheckBox = new wxCheckBox( OptionsSizer->GetStaticBox(), wxID_ANY, _("Mount volume as &read-only"), wxDefaultPosition, wxDefaultSize, 0 );
	OptionsSizer->Add( ReadOnlyCheckBox, 0, wxALL, 5 );

	RemovableCheckBox = new wxCheckBox( OptionsSizer->GetStaticBox(), wxID_ANY, _("Mount volume as removable &medium"), wxDefaultPosition, wxDefaultSize, 0 );
	OptionsSizer->Add( RemovableCheckBox, 0, wxALL, 5 );

	BackupHeaderCheckBox = new wxCheckBox( OptionsSizer->GetStaticBox(), wxID_ANY, _("Use backup header embedded in &volume if available"), wxDefaultPosition, wxDefaultSize, 0 );
	OptionsSizer->Add( BackupHeaderCheckBox, 0, wxALL, 5 );

	PartitionInSystemEncryptionScopeCheckBox = new wxCheckBox( OptionsSizer->GetStaticBox(), wxID_ANY, _("Mount partition &using system encryption (preboot authentication)"), wxDefaultPosition, wxDefaultSize, 0 );
	OptionsSizer->Add( PartitionInSystemEncryptionScopeCheckBox, 0, wxALL, 5 );

	ProtectionSizer = new wxStaticBoxSizer( new wxStaticBox( OptionsSizer->GetStaticBox(), wxID_ANY, _("Hidden Volume Protection") ), wxVERTICAL );

	ProtectionCheckBox = new wxCheckBox( ProtectionSizer->GetStaticBox(), wxID_ANY, _("&Protect hidden volume when mounting outer volume"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	ProtectionHyperlinkCtrl = new wxHyperlinkCtrl( ProtectionSizer->GetStaticBox(), wxID_ANY, _("What is hidden volume protection?"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
	...
	NoFilesystemCheckBox = new wxCheckBox( sbSizer28->GetStaticBox(), wxID_ANY, _("Do &not mount"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	MountPointTextCtrlStaticText = new wxStaticText( sbSizer28->GetStaticBox(), wxID_ANY, _("Mount at directory:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	MountPointButton = new wxButton( sbSizer28->GetStaticBox(), wxID_ANY, _("Se&lect..."), wxDefaultPosition, wxDefaultSize, 0 );
	FilesystemOptionsSizer->Add( MountPointButton, wxGBPosition( 1, 2 ), wxGBSpan( 1, 1 ), wxALIGN_CENTER_VERTICAL|wxRIGHT|wxLEFT, 5 );

	FilesystemOptionsStaticText = new wxStaticText( sbSizer28->GetStaticBox(), wxID_ANY, _("Mount options:"), wxDefaultPosition, wxDefaultSize, 0 );
...
NewSecurityTokenKeyfileDialogBase::NewSecurityTokenKeyfileDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	wxStaticText* m_staticText47;
	m_staticText47 = new wxStaticText( sbSizer42->GetStaticBox(), wxID_ANY, _("Security token:"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
	m_staticText47->Wrap( -1 );
	...
	m_staticText48 = new wxStaticText( sbSizer42->GetStaticBox(), wxID_ANY, _("Keyfile name:"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
...
PreferencesDialogBase::PreferencesDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	sbSizer13 = new wxStaticBoxSizer( new wxStaticBox( AutoDismountSizer->GetStaticBox(), wxID_ANY, _("Dismount All Volumes When") ), wxVERTICAL );

	DismountOnLogOffCheckBox = new wxCheckBox( sbSizer13->GetStaticBox(), wxID_ANY, _("User logs off"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer13->Add( DismountOnLogOffCheckBox, 0, wxALL, 5 );

	DismountOnScreenSaverCheckBox = new wxCheckBox( sbSizer13->GetStaticBox(), wxID_ANY, _("Screen saver is launched"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer13->Add( DismountOnScreenSaverCheckBox, 0, wxALL, 5 );

	DismountOnPowerSavingCheckBox = new wxCheckBox( sbSizer13->GetStaticBox(), wxID_ANY, _("System is entering power saving mode"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	DismountOnInactivityCheckBox = new wxCheckBox( AutoDismountSizer->GetStaticBox(), wxID_ANY, _("Auto-dismount volume after no data has been read/written to it for"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	ForceAutoDismountCheckBox = new wxCheckBox( AutoDismountSizer->GetStaticBox(), wxID_ANY, _("Force auto-dismount even if volume contains open files or directories"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	PreserveTimestampsCheckBox = new wxCheckBox( FilesystemSecuritySizer->GetStaticBox(), wxID_ANY, _("Preserve modification timestamp of file containers"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	WipeCacheOnCloseCheckBox = new wxCheckBox( sbSizer14->GetStaticBox(), wxID_ANY, _("Wipe after VeraCrypt window has been closed"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer14->Add( WipeCacheOnCloseCheckBox, 0, wxALL, 5 );

	WipeCacheOnAutoDismountCheckBox = new wxCheckBox( sbSizer14->GetStaticBox(), wxID_ANY, _("Wipe after volume has been auto-dismounted"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	MountReadOnlyCheckBox = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Mount volumes as read-only"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer15->Add( MountReadOnlyCheckBox, 0, wxALL, 5 );

	MountRemovableCheckBox = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Mount volumes as removable media"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer15->Add( MountRemovableCheckBox, 0, wxALL, 5 );

	CachePasswordsCheckBox = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Cache passwords in memory"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer15->Add( CachePasswordsCheckBox, 0, wxALL, 5 );

	TrueCryptModeCheckBox = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("TrueCrypt Mode"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer15->Add( TrueCryptModeCheckBox, 0, wxALL, 5 );

	wxBoxSizer* bSizer163;
	bSizer163 = new wxBoxSizer( wxHORIZONTAL );

	Pkcs5PrfStaticText = new wxStaticText( sbSizer15->GetStaticBox(), wxID_ANY, _("PKCS5-PRF:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText6 = new wxStaticText( FilesystemSizer->GetStaticBox(), wxID_ANY, _("Mount options:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	BackgroundTaskEnabledCheckBox = new wxCheckBox( sbSizer18->GetStaticBox(), wxID_ANY, _("Enabled"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer18->Add( BackgroundTaskEnabledCheckBox, 0, wxALL, 5 );

	CloseBackgroundTaskOnNoVolumesCheckBox = new wxCheckBox( sbSizer18->GetStaticBox(), wxID_ANY, _("Exit when there are no mounted volumes"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer18->Add( CloseBackgroundTaskOnNoVolumesCheckBox, 0, wxALL, 5 );

	wxStaticBoxSizer* sbSizer26;
	sbSizer26 = new wxStaticBoxSizer( new wxStaticBox( sbSizer18->GetStaticBox(), wxID_ANY, _("Task Icon Menu Items") ), wxVERTICAL );

	BackgroundTaskMenuMountItemsEnabledCheckBox = new wxCheckBox( sbSizer26->GetStaticBox(), wxID_ANY, _("Mount Favorite Volumes"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer26->Add( BackgroundTaskMenuMountItemsEnabledCheckBox, 0, wxALL, 5 );

	BackgroundTaskMenuOpenItemsEnabledCheckBox = new wxCheckBox( sbSizer26->GetStaticBox(), wxID_ANY, _("Open Mounted Volumes"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer26->Add( BackgroundTaskMenuOpenItemsEnabledCheckBox, 0, wxALL, 5 );

	BackgroundTaskMenuDismountItemsEnabledCheckBox = new wxCheckBox( sbSizer26->GetStaticBox(), wxID_ANY, _("Dismount Mounted Volumes"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	StartOnLogonCheckBox = new wxCheckBox( LogOnSizer->GetStaticBox(), wxID_ANY, _("Start VeraCrypt Background Task"), wxDefaultPosition, wxDefaultSize, 0 );
	LogOnSizer->Add( StartOnLogonCheckBox, 0, wxALL, 5 );

	MountFavoritesOnLogonCheckBox = new wxCheckBox( LogOnSizer->GetStaticBox(), wxID_ANY, _("Mount favorite volumes"), wxDefaultPosition, wxDefaultSize, 0 );
	LogOnSizer->Add( MountFavoritesOnLogonCheckBox, 0, wxALL, 5 );

	MountDevicesOnLogonCheckBox = new wxCheckBox( LogOnSizer->GetStaticBox(), wxID_ANY, _("Mount all device-hosted VeraCrypt volumes"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	OpenExplorerWindowAfterMountCheckBox = new wxCheckBox( ExplorerSizer->GetStaticBox(), wxID_ANY, _("Open Explorer window for successfully mounted volume"), wxDefaultPosition, wxDefaultSize, 0 );
	ExplorerSizer->Add( OpenExplorerWindowAfterMountCheckBox, 0, wxALL, 5 );

	CloseExplorerWindowsOnDismountCheckBox = new wxCheckBox( ExplorerSizer->GetStaticBox(), wxID_ANY, _("Close all Explorer windows of volume being dismounted"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	NoKernelCryptoCheckBox = new wxCheckBox( KernelServicesSizer->GetStaticBox(), wxID_ANY, _("Do not use kernel cryptographic services"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText57 = new wxStaticText( sbSizer44->GetStaticBox(), wxID_ANY, _("Processor (CPU) in this computer supports hardware acceleration for AES:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	NoHardwareCryptoCheckBox = new wxCheckBox( sbSizer44->GetStaticBox(), wxID_ANY, _("Do not accelerate AES encryption/decryption by using the AES instructions of the processor"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	SelectPkcs11ModuleButton = new wxButton( sbSizer36->GetStaticBox(), wxID_ANY, _("Select &Library..."), wxDefaultPosition, wxDefaultSize, 0 );
	...
	CloseSecurityTokenSessionsAfterMountCheckBox = new wxCheckBox( sbSizer37->GetStaticBox(), wxID_ANY, _("&Close token session (log out) after a volume is successfully mounted"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText10 = new wxStaticText( sbSizer23->GetStaticBox(), wxID_ANY, _("Key to assign:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	AssignHotkeyButton = new wxButton( sbSizer23->GetStaticBox(), wxID_ANY, _("Assign"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	HotkeyControlCheckBox = new wxCheckBox( sbSizer23->GetStaticBox(), wxID_ANY, _("Control"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer4->Add( HotkeyControlCheckBox, 0, wxALL, 5 );

	HotkeyShiftCheckBox = new wxCheckBox( sbSizer23->GetStaticBox(), wxID_ANY, _("Shift"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer4->Add( HotkeyShiftCheckBox, 0, wxALL, 5 );

	HotkeyAltCheckBox = new wxCheckBox( sbSizer23->GetStaticBox(), wxID_ANY, _("Alt"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer4->Add( HotkeyAltCheckBox, 0, wxALL, 5 );

	HotkeyWinCheckBox = new wxCheckBox( sbSizer23->GetStaticBox(), wxID_ANY, _("Win"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer4->Add( HotkeyWinCheckBox, 0, wxALL, 5 );


	fgSizer4->Add( gSizer4, 1, wxEXPAND, 5 );

	RemoveHotkeyButton = new wxButton( sbSizer23->GetStaticBox(), wxID_ANY, _("Remove"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer24 = new wxStaticBoxSizer( new wxStaticBox( sbSizer21->GetStaticBox(), wxID_ANY, _("Options") ), wxVERTICAL );

	BeepAfterHotkeyMountDismountCheckBox = new wxCheckBox( sbSizer24->GetStaticBox(), wxID_ANY, _("Play system notification sound after mount/dismount"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer24->Add( BeepAfterHotkeyMountDismountCheckBox, 0, wxALL, 5 );

	DisplayMessageAfterHotkeyDismountCheckBox = new wxCheckBox( sbSizer24->GetStaticBox(), wxID_ANY, _("Display confirmation message box after dismount"), wxDefaultPosition, wxDefaultSize, 0 );
...
RandomPoolEnrichmentDialogBase::RandomPoolEnrichmentDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	MouseStaticText = new wxStaticText( sbSizer43->GetStaticBox(), wxID_ANY, _("IMPORTANT: Move your mouse as randomly as possible within this window. The longer you move it, the better. This significantly increases security. When done, click 'Continue'."), wxDefaultPosition, wxDefaultSize, 0 );
	MouseStaticText->Wrap( -1 );
	sbSizer43->Add( MouseStaticText, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );
...
EncryptionOptionsWizardPageBase::EncryptionOptionsWizardPageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : WizardPage( parent, id, pos, size, style, name )
{
	...
	EncryptionAlgorithmHyperlink = new wxHyperlinkCtrl( sbSizer29->GetStaticBox(), wxID_ANY, _("More information"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
	...
	BenchmarkButton = new wxButton( sbSizer29->GetStaticBox(), wxID_ANY, _("&Benchmark"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	HashHyperlink = new wxHyperlinkCtrl( sbSizer30->GetStaticBox(), wxID_ANY, _("Information on hash algorithms"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
...
VolumeCreationProgressWizardPageBase::VolumeCreationProgressWizardPageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : WizardPage( parent, id, pos, size, style, name )
{
	...
	m_staticText25 = new wxStaticText( sbSizer31->GetStaticBox(), wxID_ANY, _("Random Pool:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	DisplayKeysCheckBox = new wxCheckBox( sbSizer31->GetStaticBox(), wxID_ANY, _("Show"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText28 = new wxStaticText( sbSizer31->GetStaticBox(), wxID_ANY, _("Header Key:"), wxDefaultPosition, wxSize( -1,-1 ), 0 );
	...
	m_staticText29 = new wxStaticText( sbSizer31->GetStaticBox(), wxID_ANY, _("Master Key:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	AbortButton = new wxButton( sbSizer32->GetStaticBox(), wxID_ANY, _("Abort"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText31 = new wxStaticText( sbSizer32->GetStaticBox(), wxID_ANY, _("Done"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText311 = new wxStaticText( sbSizer32->GetStaticBox(), wxID_ANY, _("Speed"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText312 = new wxStaticText( sbSizer32->GetStaticBox(), wxID_ANY, _("Left"), wxDefaultPosition, wxDefaultSize, 0 );
...
VolumeFormatOptionsWizardPageBase::VolumeFormatOptionsWizardPageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : WizardPage( parent, id, pos, size, style, name )
{
	...
	m_staticText43 = new wxStaticText( sbSizer33->GetStaticBox(), wxID_ANY, _("Filesystem type:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText43->Wrap( -1 );
	...
	QuickFormatCheckBox = new wxCheckBox( sbSizer34->GetStaticBox(), wxID_ANY, _("Quick format"), wxDefaultPosition, wxDefaultSize, 0 );
...
VoiceDialogBase::VoiceDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	sbSizer48 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("Recording") ), wxVERTICAL );

	m_staticText71 = new wxStaticText( sbSizer48->GetStaticBox(), wxID_ANY, _("Press to start recording wake word, press again to stop:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText71->Wrap( -1 );
	sbSizer48->Add( m_staticText71, 0, wxALL, 5 );

	WakeRecordButton = new wxButton( sbSizer48->GetStaticBox(), wxID_ANY, _("Record Wake Word"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer48->Add( WakeRecordButton, 0, wxALL, 5 );

	m_staticText72 = new wxStaticText( sbSizer48->GetStaticBox(), wxID_ANY, _("Press to start recording random noises, press again to stop:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText72->Wrap( -1 );
	sbSizer48->Add( m_staticText72, 0, wxALL, 5 );

	NonWakeRecordButton = new wxButton( sbSizer48->GetStaticBox(), wxID_ANY, _("Record Non-Wake Word"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText73 = new wxStaticText( sbSizer49->GetStaticBox(), wxID_ANY, _("Press this to start training model with recorded sounds:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer49->Add( m_staticText75, 0, wxALL, 5 );

	m_button68 = new wxButton( sbSizer49->GetStaticBox(), wxID_ANY, _("Start safe mode"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText74 = new wxStaticText( sbSizer50->GetStaticBox(), wxID_ANY, _("Press to purge all recordings and reset model:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText74->Wrap( -1 );
	sbSizer50->Add( m_staticText74, 0, wxALL, 5 );

	m_button67 = new wxButton( sbSizer50->GetStaticBox(), wxID_ANY, _("Purge all files"), wxDefaultPosition, wxDefaultSize, 0 );
...
VoiceDialogBase::~VoiceDialogBase()
{
	// Disconnect Events
...
ConfirmResetDialogBase::ConfirmResetDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_staticText76 = new wxStaticText( this, wxID_ANY, _("Are you sure you want to delete all recordings and reset your model?"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText76->Wrap( -1 );
	bSizer169->Add( m_staticText76, 0, wxALL, 5 );
	...
	bSizer168->Add( m_sdbSizer5, 1, wxEXPAND, 5 );
	...
	// Connect Events
	m_sdbSizer5OK->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ConfirmResetDialogBase::OnOkButtonClick ), NULL, this );
}

ConfirmResetDialogBase::~ConfirmResetDialogBase()
{
	// Disconnect Events
	m_sdbSizer5OK->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ConfirmResetDialogBase::OnOkButtonClick ), NULL, this );
