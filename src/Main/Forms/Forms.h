...
namespace VeraCrypt
{
	...
	class MainFrameBase : public wxFrame
	{
		...
		protected:
			...
			virtual void OnVoiceDismountMenuItemSelected( wxCommandEvent& event ) { event.Skip(); }
	...
	///////////////////////////////////////////////////////////////////////////////
	/// Class VoiceDialogBase
	///////////////////////////////////////////////////////////////////////////////
	class VoiceDialogBase : public wxDialog
	{
		private:

		protected:
			wxStaticText* m_staticText71;
			wxButton* WakeRecordButton;
		...
		public:
			...
			VoiceDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Voice Dismount"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 460,622 ), long style = wxDEFAULT_DIALOG_STYLE );
			~VoiceDialogBase();

	};

	///////////////////////////////////////////////////////////////////////////////
	/// Class ConfirmResetDialogBase
	///////////////////////////////////////////////////////////////////////////////
	class ConfirmResetDialogBase : public wxDialog
	{
		private:
		...
		public:
			...
			ConfirmResetDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("VeraCrypt"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxDEFAULT_DIALOG_STYLE );
			~ConfirmResetDialogBase();
